...
const ap = new APlayer({
	    ...
	    data: {TransCode:'020112',OpenId:'Test',Body:{SongListId:'2082908643'}},
            dataType: 'json',		
            success: function (result) {
	      if(result.ResultCode==1){
		$.each(result.Body,function(item){
                   ap.list.add([{name:item.title,artist:item.author,cover:item.pic,url:item.url,lrc:item.lrc}]);
		});
	      }
            }
        }); 
